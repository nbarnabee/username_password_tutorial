...
// what's happening here is that if there is no "user" information sent with the request (which would indicate that it's not being made by a logged-in user), the server responds with a rendering of "home.ejs"
// if, however, the user has been authenticated, the server responds by fetching the toDos and rendering the index page
